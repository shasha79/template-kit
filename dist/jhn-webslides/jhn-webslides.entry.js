        ...
        h(
          ...
          h(
            ...
            h(
              'div',
              {class: 'slide-info'},
              h('h2', {class: 'slide-info_headline', slot: 'headline'}, h('slot', {name: 'headline'}, 'A J-Story Virtual Exhibit')),
              h(
                'h1',
                {class: 'slide-info_title'},
                h('slot', {name: 'title'}, h('strong', null, 'Jewish Women'), ' in the Century of Change')
              ),
              h(
                'h3',
                {class: 'slide-info_subtitle'},
                h('slot', {name: 'subtitle'}, 'Optional Sub-Headline Text to Describe this Virtual Exhibit')
              ),
              h(
                'div',
